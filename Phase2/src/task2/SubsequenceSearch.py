...
class SubsequenceSearch:
    ...
    def save_video_sequence(self, video_name=None, start=-1, end=-1, rank=-1):
        ...
        out = cv2.VideoWriter(out_file_name + '.avi', fourcc, video.get(cv2.cv.CV_CAP_PROP_FPS),
...
if __name__ == "__main__":
    dir_path = "C:\\Users\\Giridhar\\Desktop\\MWDB Project\\DemoVideos"#raw_input("Enter input directory path: ")
    vname = "6x_SQ_TL_BR_Check.mp4" #raw_input("Enter video file name: ")
    method_name = "histogram"#raw_input("Enter method name to be used for search: ")
    ...
    feature_file  = "C:\\Users\\Giridhar\\Desktop\\MWDB Project\\MWDB\\Phase2\\sample_data\\input\\histogram.chst"#raw_input("Enter feature file path: ")
