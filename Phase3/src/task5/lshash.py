...
#lsh.index([1,1,1,1,1,1,1,1])
#lsh.index([1,2,3,1,2,3,3,3])
#print type(lsh.hash_tables)
#print len(lsh.hash_tables)
#for i in lsh.hash_tables:
 #   print type(i)
  #  print type(i.storage)
   ##for x in i.storage:
     #   print (x)
      #  for y in i.storage[x]:
       #     print (y, ':', i.storage[x][y])
    #b#reak
